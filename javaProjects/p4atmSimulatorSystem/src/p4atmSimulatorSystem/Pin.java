...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(260,220,700,35);
        l4.add(l1);
        
        l2.setBounds(170,270,150,35);
        l4.add(l2);
        
        l3.setBounds(170,310,200,35);
        l4.add(l3);
        
        t1.setBounds(360,270,140,35);
        l4.add(t1);
        
        t2.setBounds(360,310,140,35);
        l4.add(t2);
